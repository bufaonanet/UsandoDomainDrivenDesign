...
namespace Store.Tests.Domain
{
    ...
    {
        public readonly Customer _customer = new Customer("douglas", "douglas@email.com");
        public readonly Product _product = new Product("Produto", 10, true);
        public readonly Discount _discount = new Discount(10, DateTime.Now.AddDays(5));
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_novo_pedido_valido_seu_valor_deve_ser_50()
        {
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_desconto_10_o_valor_do_pedido_deve_ser_50()
        {
            var order = new Order(_customer, 10, _discount);
            order.AddItem(_product, 5);
            Assert.AreEqual(order.Total(), 50);
